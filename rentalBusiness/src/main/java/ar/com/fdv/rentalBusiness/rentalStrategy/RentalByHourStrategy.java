...
public class RentalByHourStrategy extends RentalStrategy{
	...
	@Override
	public Float rent(Bike bike, Integer hoursQuantity) throws IOException, BadRequestException {
	...
	private Float calculateCharge(Integer hoursQuantity) throws IOException {
		ApplicationProperties applicationProperties = ApplicationProperties.getInstance();
		String chargeByHour = applicationProperties.getPropertyValue("CHARGE_BY_HOUR");	
		return new Float(new Float(hoursQuantity) * new Float(chargeByHour));
	}
}
